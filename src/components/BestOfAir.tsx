...
export default function BestOfAir() {
  const scrollLeft = () => {
    ...
    if (slider) {
      slider.scrollLeft -= 300; // Scroll 300px to the left
    }
  };
  ...
  const scrollRight = () => {
    const slider = document.getElementById("slider");
    if (slider) {
      slider.scrollLeft += 300; // Scroll 300px to the right
    }
  };

  return (
    <section className="best-of-air w-full py-10 bg-white flex flex-col items-start px-4 md:px-10">
      {/* Left Side Heading */}
      ...
      <div className="relative w-full flex items-center">
        ...
        >
          ...
          <div className="flex-shrink-0 w-[70%] md:w-1/3">
            <Image
              src="/images/br1.png" // Replace with actual path
          ...
          <div className="flex-shrink-0 w-[70%] md:w-1/3">
            <Image
              src="/images/br2.png" // Replace with actual path
              alt="Nike Air Max 97"
              width={480}
              height={480}
              className="object-cover rounded-md w-full"
          ...
          <div className="flex-shrink-0 w-[70%] md:w-1/3">
            <Image
              src="/images/br3.png" // Replace with actual path
